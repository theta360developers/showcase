                ...
                <div class="product-images-carousel-wrapper">
                    ...
                    <div class="productMainImage">
                        <ul class="bxslider product-view-slides product-view-slides-h">
                            <li><img src="images/product_details/low-res-croped/1.jpg" alt="img"/></li>
                            <li><img src="images/product_details/low-res-croped/2.jpg" alt="img"/></li>
                            <li><img src="images/product_details/low-res-croped/3.jpg" alt="img"/></li>
                            <li>
                                <iframe src="https://player.vimeo.com/video/95929658" width="500" height="281"
                    ...
                    <div class="product-view-thumb-wrapper has-carousel-v">
                        ...
                        <ul id="bx-pager" class="product-view-thumb">
                            <li><a class="thumb-item-link" data-slide-index="0" href=""><img
                                    src="images/product_details/low-res-croped/1.jpg" alt="img"/></a></li>
                            <li><a class="thumb-item-link" data-slide-index="1" href=""><img
                                    src="images/product_details/low-res-croped/2.jpg" alt="img"/></a></li>
                            <li><a class="thumb-item-link" data-slide-index="2" href=""><img
                                    src="images/product_details/low-res-croped/3.jpg" alt="img"/></a></li>
                            <li><a class="thumb-item-link" data-slide-index="3" href=""><img
                                    src="images/product_details/low-res-croped/video-thumb.jpg" alt="img"/></a></li>
                        </ul>
