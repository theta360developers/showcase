...
<section class="section-product-info  wow fadeIn" data-wow-duration=".8s" data-wow-delay="0">
        ...
        <div class="row">
                ...
                <div class="product-images-carousel-wrapper">
                    ...
                    <div class="product-images-carousel">
                        ...
                        <div class="product-carousel-item">
                            ...
                            <img class="img-responsive product-carousel-item-img lazyOwl " src=".."
          ...
          <span class="zoom-image-overly"
                data-image="images/product_details/hi-res/2.jpg">
                            ...
                            <img class="img-responsive product-carousel-item-img lazyOwl"
                                 data-src='images/product_details/low-res/2.jpg' src="..." alt='Image Title'/>
                        </div>
          ...
          <span class="zoom-image-overly"
                data-image="images/product_details/hi-res/3.jpg">
                            ...
                            <img class="img-responsive product-carousel-item-img lazyOwl"
                                 data-src='images/product_details/low-res/3.jpg' src="..." alt='Image Title'/>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="review-title-bar">
                        <a class="scrollto pull-right" href="#product-review"><i class="fa fa-comment-o"></i> 12 Review</a>
    ...
    <div class="product-story-inner ">
        ...
        <div class="container ">
            ...
            <div class="row has-equal-height-child">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  is-equal">
                    <div class="hw100 display-table">
                        <div class="hw100 display-table-cell">
                            ...
                            <div class="product-story-info-box wow fadeInRight" data-wow-duration="1s"
                                 data-wow-delay="0">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  is-equal">
                    <div class="product-story-a-img wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.25s">
