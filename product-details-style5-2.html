                ...
                <div class="product-images-carousel-wrapper">
                    ...
                    <div class="product-images-carousel">
                        ...
                        <div class="product-carousel-item">
                            <span class="zoom-image-overly"
                                  data-image="images/product_details/hi-res/1.jpg">

                            </span>

                            <img class="img-responsive product-carousel-item-img lazyOwl "
                                 data-src='images/product_details/low-res/1.jpg' alt='Image Title'/>
                        </div>

                        <div class="product-carousel-item">
          <span class="zoom-image-overly"
                data-image="images/product_details/hi-res/2.jpg">

                            </span>

                            <img class="img-responsive product-carousel-item-img lazyOwl"
                                 data-src='images/product_details/low-res/2.jpg' alt='Image Title'/>
                        </div>

                        <div class="product-carousel-item">
          <span class="zoom-image-overly"
                data-image="images/product_details/hi-res/3.jpg">

                            </span>

                            <img class="img-responsive product-carousel-item-img lazyOwl"
                                 data-src='images/product_details/low-res/3.jpg' alt='Image Title'/>
                        </div>
                                    ...
                                    <div class="product-story-info-box">
                                        <div class="product-story-info-text ">
                                            ...
                                            <p class="desc">
                                                ...
                                                malesuada fames ac turpis egestas. Vestibulum sed ante et lectus sodales
                                                rhoncus. Maecenas tristique libero eget vulputate malesuada.
                                                Pellentesque
                                                orci turpis, venenatis scelerisque tellus ut, euismod dignissim risus.
                                                Nunc
                                                condimentum, sapien sit amet condimentum ultricies, enim mauris
                                                posuere </p>

                                            <p><strong> 100% cotton</strong> <br>
                                                Machine wash cold, Fits true to size, take your normal size.</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  is-equal">
                            <div class="hw100 display-table">
                                <div class="hw100 display-table-cell">
                                    ...
                                    <div class="product-story-info-box">
                                        <div class="product-story-info-text " data-wow-duration=".8s"
                                             data-wow-delay="0">
                                        ...
                                        <div class="product-story-info-text wow fadeInLeft" data-wow-duration=".8s"
                                            ...
                                            <div class="inner-content">
                                                ...
                                                <ul class="list-unstyled no-padding">
                                                    ...
                                                    <li><strong>Fabric:</strong> panel: 80 g/m² 100% Maecenas id eros
                                                        nec tellus
                                                        facilisis varius
                                                    </li>
                                            ...
                                            <a class="btn btn-default btn-link" data-target="#modal-size-guide"
                                               data-toggle="modal"> View Size Guide <i
                    ...
                    <div class="all-review-wrapper ">
                        ...
                        <div class="row review-item">
                            ...
                            <div class="col-lg-9  col-sm-9 right">
                                ...
                                <div class="rating commentRating">
                                    <p><span><i class="fa fa-star"></i></span> <span><i class="fa fa-star"></i></span>
                                        <span><i class="fa fa-star"></i></span> <span><i class="fa fa-star"></i></span>
                                        <span> <i class="fa fa-star-o "></i> </span> <span
                                                class="ratingInfo"> <span> / </span> <a data-target="#modal-review"
                                                                                        data-toggle="modal">
                                            4.0 </a> </span></p>
                                </div>
                                ...
                                <p class="commentText">
                                    ...
                                    dissentias, pri ea melius laoreet delicatissimi.</p>
                        ...
                        <div class="row review-item">
                            ...
                            <div class="col-lg-9  col-sm-9 right">
                                ...
                                <p class="commentText">
                                    Ut eam tamquam ullamcorper vituperatoribus. Saepe nonumy complectitur duo id, eam
                                    labores ponderum no, timeam elaboraret repudiandae ea quo. Dolores efficiendi
                                    complectitur eos eu. Id sed brute nemore, eu sed agam democritum intellegam.</p>
                        ...
                        <div class="row review-item">
                            ...
                            <div class="col-lg-9  col-sm-9 right">
                                ...
                                <p class="commentText">
                                    ...
                                    Graece utamur reformidans vix in. No iisque detraxit senserit vim, mei ut menandri
                                    periculis. Eu vide dolorum cotidieque vix, cum minim voluptua principes ad. Mei
                                    omnis option persius ut, pri fastidii oporteat complectitur et, est cu novum
                                    temporibus. Id nulla semper dolorum pro.</p>
...
<section class=" section-similar-product graybg">
    <div class="container">
