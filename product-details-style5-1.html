        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                <div class="product-images-carousel-wrapper">
                    <nav class="slider-nav has-white-bg nav-narrow-svg"><a class="prev"> <span class="icon-wrap"></span>
                    </a> <a class="next"> <span class="icon-wrap"></span> </a></nav>
                    <div class="product-images-carousel">
                        <div class="product-carousel-item"> <span class="zoom-image-overly"
                                                                  data-image="images/product_details/hi-res/1.jpg"> </span>
                            <img class="img-responsive product-carousel-item-img lazyOwl "
                                 data-src='images/product_details/low-res/1.jpg' src=".." alt='Image Title'/></div>
                        <div class="product-carousel-item"> <span class="zoom-image-overly"
                                                                  data-image="images/product_details/hi-res/2.jpg"> </span>
                            <img class="img-responsive product-carousel-item-img lazyOwl"
                                 data-src='images/product_details/low-res/2.jpg' src=".." alt='Image Title'/></div>
                        <div class="product-carousel-item"> <span class="zoom-image-overly"
                                                                  data-image="images/product_details/hi-res/3.jpg"> </span>
                            <img class="img-responsive product-carousel-item-img lazyOwl"
                                 data-src='images/product_details/low-res/3.jpg' src=".." alt='Image Title'/></div>
                    </div>
                </div>
            </div>
            <!--/ left column end -->
            ...
            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                <div class="product-details-info-wrapper">
                    ...
                    <div class="product-price"><span class="price-sales"> $ 70</span> <span class="price-standard hide">$ 95</span>
                        <span class="price-tag"> including tax</span></div>
                    <div class="product-details-product-color"> <span
                            class="selected-color"><strong>Colour </strong> <span
...
" style="background-color:Red"> </a></li>
 ...
 " style="background-color:purple"> </a></li>
                    ...
                    <div class="row row-cart-actions clearfix ">
                        <div class="col-sm-12 "><a class="btn btn-block btn-dark"> Add to cart </a> <a
                                class="btn btn-block btn-gray"> Add to Wishlist </a></div>
                    </div>
                    <div class="clear"></div>
                    <div class="product-details-info">
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-blank ">
                                <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title"><a class="collapsed" role="button" data-toggle="collapse"
                                                               tite data-parent="#accordion"
                                                               href="#collapseOne" aria-expanded="true"
                                                               aria-controls="collapseOne"> ABOUT </a></h4>
                                </div>
                                <div id="collapseOne" class="panel-collapse collapse " role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <ul class="discription-list-inner bullet-list list-check">
                                            <li>
                                                <p><span>Vestibulum rutrum imperdiet nunc a interdum. In scelerisque libero </span>
                                                </p>
                                            </li>
                                            <li>
                                                <p><span>ut elit porttitor commodo. </span></p>
                                            </li>
                                            <li>
                                                <p><span> <strong>100% Cotton</strong></span></p>
                                            </li>
                                            <li>
                            ...
                            <div class="panel panel-blank ">
                                <div class="panel-heading" role="tab" id="headingTwo">
                                    <h4 class="panel-title"><a class="collapsed" role="button" data-toggle="collapse"
                                                               ...
                                                               aria-expanded="false"
                                                               aria-controls="collapseTwo"> SIZE & FIT </a></h4>
                                </div>
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                     aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                        <ul class="discription-list-inner">
                                            <li><strong>Size &amp; Fit</strong>

                                                <p> <span>Measurements taken from size 30<br>
                          Model wears size 31. Model is 6'2 </span></p>
                                            </li>
                                            <li><strong>Fitting Information </strong>
                          ...
                          Style: XCES<br>
                          <br>
                          <a data-toggle="modal" data-target="#modal-size-guide"
                             class="btn btn-default btn-link btn-sm"> View Size Guide <i
            ...
            <div class="row">
                <div class="col-lg-8">
                    <ul class="list-unstyled list-inline social-inline">
                        <li class="hasShareCount"><span>Share <span class="count">120</span></span></li>
                ...
                <div class="col-lg-4">
                    <div class="review-title-bar"><a class="scrollto pull-right" href="#product-review"><i
                            class="fa fa-comment-o"></i> 12 Review</a></div>
                </div>
            </div>
        </div>
    </div>
...
<div style="clear: both"></div>
<section class="product-story-boxes whitebg  product-story-2">
    <div class="product-story-inner ">
        <div class="container-full">
            <div class="row-boxes has-equal-height-child">
                        ...
                        <div class="hw100 display-table-cell">
                            <div class="product-story-info-box">
                                <div class="product-story-info-text wow fadeInLeft" data-wow-duration=".8s"
                                    ...
                                    <p class="desc"> In legendos salutatus qui, sit primis percipit probatus at. Est
                                        vidit iuvaret
                                        platonem eu. Et nam suas sint. Adhuc putant vivendo in has, omittam persecuti
                                        pro in. An ceteros tacimates facilisis nam, ex magna consul per. </p>
                                    <ul class="list">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hasBg is-equal cover"
                     style="background-image: url('images/product_details/p-bg-1.jpg')  ">
                    <div class="product-story-a-img wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.25"></div>
                </div>
            </div>
        </div>
    </div>
...
<div style="clear: both"></div>
<section class="product-story-boxes  whitebg  product-story-3">
    <div class="product-story-inner ">
        <div class="container-full">
            <div class="row-boxes has-equal-height-child">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hasBg is-equal cover"
                     style="background-image: url('images/product_details/p-bg-2.jpg')  ">
                    <div class="product-story-a-img wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.25"></div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  is-equal">
                    <div class="hw100 display-table">
                            ...
                            <div class="product-story-info-box">
                                <div class="product-story-info-text wow fadeInLeft" data-wow-duration=".8s"
                                    ...
                                    <div class="inner-content">
                                        <p> In legendos salutatus qui, sit primis percipit probatus at. Est vidit
                                            iuvaret platonem eu. Et nam suas sint. Adhuc putant vivendo in has, omittam
                                            persecuti pro in. An ceteros tacimates facilisis nam, ex magna consul
                                            per. </p>
                                        <ul class="list-unstyled no-padding">
                                            ...
                                            <li><strong>Source:</strong> Imported</li>
    ...
    <div class="product-story-inner ">
        <div class="container">
            <div class="product-story-info-text"
                ...
                <p class="desc"> Cras et vehicula risus, at ultricies neque. efficitur ac ex sollicitudin,
                    ...
                    Fusce lectus lorem, ultricies eget lectus at, malesuada volutpat neque. </p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="hero-section-header productReviewTitleBAr">
            ...
            <div class="rating commentRating">
                <p><span><i class="fa fa-star"></i></span> <span><i class="fa fa-star"></i></span> <span><i
                        ...
                        class="ratingNumber">4.0 </span> Average rating</span></p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="all-review-wrapper wow  fadeIn">
            <div class="row review-item">
                <div class="col-lg-3 col-sm-3  left">
                    <div class="review-item-user">
                        <div class="review-item-user-profile"><img class="img-circle" alt=""
                                                                   src="images/product_details/user-2.jpg"></div>
                        <div class="user-name">
                            <p>John Doe </p>
                            <small>5m ago</small>
                        </div>
                ...
                <div class="col-lg-9  col-sm-9 right">
                    ...
                    <p class="commentText"> Lorem ipsum dolor sit amet, nam odio prompta ne. Mea semper repudiare in,
                        eos ei dico tamquam
            ...
            <div class="row review-item">
                <div class="col-lg-3 col-sm-3  left">
                    <div class="review-item-user">
                        <div class="review-item-user-profile"><img class="img-circle" alt=""
                                                                   src="images/site/default-user.png"></div>
                        <div class="user-name">
                            <p>John Doe </p>
                            <small>5m ago</small>
                        </div>
                ...
                <div class="col-lg-9  col-sm-9 right">
                    ...
                    <p class="commentText"> Ut eam tamquam ullamcorper vituperatoribus. Saepe nonumy complectitur duo
                        id, eam labores
            ...
            <div class="row review-item">
                ...
                <div class="col-lg-9  col-sm-9 right">
                    ...
                    <p class="commentText"> Graece utamur reformidans vix in. No iisque detraxit senserit vim, mei ut
                        menandri periculis. Eu
            ...
            <div class="row">
                <div class="col-lg-12 review-load-more">
                    <div class=" text-center"><a href="#" class="btn  btn-default  "> <i class="fa fa-plus-sign">+</i>
                        Load 8 more reviews</a> <a class="btn  btn-success" data-target="#modal-review"
                                                   data-toggle="modal"> <i class="fa fa-edit"></i> Write reviews</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section-content">
            <div class="row has-equal-height-child">
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner"><a data-placement="left"
                                                               data-original-title="Add to Wishlist"
                                                               data-toggle="tooltip"
                                                               class="add-fav wisthlist-flat tooltipHere"> <i
                            class="glyphicon glyphicon-heart"></i> </a>

                        <div class="imageHover hasCart"><a href="product-details.html"> <img
                                class="img-responsive primaryImage" alt="img" src="images/product/54a.jpg"> <img
                                class="img-responsive secondaryImage" alt="img" src="images/product/54b.jpg"></a>

                            <div class="product-btn-box"><a class="btn btn-product-flat btn-primary"> <span
                                    class="add2cart"><i
                                    class="glyphicon glyphicon-shopping-cart"> </i> Add to cart </span> </a></div>
                        </div>
                        <div class="prod-details">
                            <p class="title"> Men Flat TShirt </p>

                            <p class="product-flat-info"><span class="product-curreent-price"> $60.00 </span> &nbsp;|&nbsp;
                                <span class="product-model">Mixed Grey </span></p>

                            <div class="product-color"><a style="background-color:#f1f40e"> </a> <a
                                    style="background-color:#adadad"> </a> <a style="background-color:#4EC67F"> </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner"><a data-placement="left"
                        ...
                        <div class="imageHover hasCart"><a href="product-details.html"> <img
                                class="img-responsive primaryImage" alt="img" src="images/product/53a.jpg"> <img
                                class="img-responsive secondaryImage" alt="img" src="images/product/53b.jpg"></a>
                        ...
                        <div class="prod-details">
                            <p class="title"> Women Flat TShirt </p>

                            <p class="product-flat-info"><span class="product-curreent-price"> $100.00 </span> &nbsp;|&nbsp;
                                <span class="product-model">Mixed Grey </span></p>

                            <div class="product-color"><a style="background-color:#f1f40e"> </a> <a
                                    style="background-color:#FE6FC3"> </a> <a style="background-color:#4EC67F"> </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner"><a data-placement="left"
                        ...
                        <div class="imageHover hasCart"><a href="product-details.html"> <img
                                class="img-responsive primaryImage" alt="img" src="images/product/50a.jpg"> <img
                                class="img-responsive secondaryImage" alt="img" src="images/product/50b.jpg"></a>
                        ...
                        <div class="prod-details">
                            ...
                            <div class="product-color"><a style="background-color:#73A44A"> </a> <a
                                    style="background-color:#adadad"> </a> <a style="background-color:#4EC67F"> </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner"><a data-placement="left"
                        ...
                        <div class="imageHover hasCart"><a href="product-details.html"> <img
                                class="img-responsive primaryImage" alt="img" src="images/product/51a.jpg"> <img
                                class="img-responsive secondaryImage" alt="img" src="images/product/51b.jpg"></a>
...
<footer class="main-footer">
    <div class="footer-content">
        <div class="container">
            <div class="row">
                <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-6 col-xxs-12">
                ...
                <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-6 col-xxs-12">
                    <div class="footer-col">
                        ...
                        <ul class="list-unstyled footer-nav">
                            <li><a href="#">Spring/Summer 2015 </a></li>
                            <li><a href="#">Spring/Summer 2014 </a></li>
                            <li><a href="#"> London Fashion Week </a></li>
                            <li><a href="#"> Paris Fashion Week </a></li>
                            <li><a href="#"> Look Back </a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer-col row">
                        ...
                        <div class="col-sm-12 col-xs-6 col-xxs-12 ">
                          ...
                          <button class="btn btn-default" type="button"><span
                                  class="glyphicon glyphicon-chevron-right"></span> <span class="sr-only">GO</span>
                          </button>
                          </span></div>
                ...
                <div style="clear: both"></div>
                <div class="col-lg-12">
                    <div class=" text-center paymanet-method-logo"><img src="images/site/payment/master_card.png"
                                                                        alt="img"> <img alt="img"
                                                                                        src="images/site/payment/visa_card.png">
                        <img alt="img" src="images/site/payment/paypal.png"> <img alt="img"
                                                                                  src="images/site/payment/american_express_card.png">
                        <img alt="img"
                             src="images/site/payment/discover_network_card.png"> <img alt="img"
                                                                                       src="images/site/payment/google_wallet.png">
                    </div>
                    <div class="copy-info text-center"> &copy; 2015 Tshop Template &amp; Co.</div>
                </div>
            </div>
        </div>
    </div>
