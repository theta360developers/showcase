    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="product-title" href="images/product_details/hi-res-croped/1.jpg"><img
                        class="zoomImage1 img-responsive" data-src="images/product_details/hi-res-croped/1.jpg"
                        src='images/product_details/low-res-white/1.jpg' alt='Daisy on the Ohoopee'/></a>
            </div>
            ...
            <div class="zoomThumb ">
                <a class="zoomThumbLink">
                    <img data-large="images/product_details/hi-res-croped/1.jpg"
                         src="images/product_details/low-res-white/1.jpg" alt="Saleen" title=""/></a>

                <a class="zoomThumbLink">
                    <img data-large="images/product_details/hi-res-croped/2.jpg"
                         src="images/product_details/low-res-white/2.jpg" alt="Saleen" title=""/></a>

                <a class="zoomThumbLink">
                    <img data-large="images/product_details/hi-res-croped/3.jpg"
                         src="images/product_details/low-res-white/3.jpg" alt="Saleen" title=""/></a>
